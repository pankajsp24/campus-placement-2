...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <br />
      <br />
      <h1 align="center"><b>Welcome to - <a href="job_vacancies.php">Job Vacancies</b></a></h1><br />
...
<?php
  ...
  while ($retrive = mysqli_fetch_array($result)) 
  {
    ...
    echo "<th>$sallary</th>";
    echo "<th>$place</th>";
    echo "<th><a href='apply_job.php?apl=$id'<button class='btn btn-success'>Apply</button></th>";
