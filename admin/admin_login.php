...
<head>
  ...
  <link rel="icon" href="images/favicon.ico">
	...
	<style type="text/css">
		body{font-family: all; background-image: url(images/adminlogin.jpg); background-size: 100%;}
		...
		.megacontainer{padding: 20px;margin-top:15px; background-color: rgba(255,255,255, 0.5); width: 30%; height: 40%; border-radius: 24px; border: 2px solid #ffffff; margin-right: auto; margin-left: auto; opacity: 90%;}
	</style> 
</head>
<body>
	<br>
...
<div class="megacontainer" style="padding-top: 25px">
	...
	<div class="imgcontainer">
		<img src="images/adminlogin1.png" alt="Avtar" class="avtar">
		<center><h1>Admin Login</h1></center>
	</div>
	<div class="container">
		
		<input type="string" name="admin_name" placeholder="Admin" required="">
