...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <br />
      <br />
      <h1 align="center"><b>Welcome to - <a href="manage_job.php"> Manage Jobs</b></a></h1><br />

      <center>
        <a href='admin_dashboard.php'><input type="submit" name="back" style="margin-top:5px;" class="btn btn-danger" value="Back" /></a>
        <a href='add_job.php'><input type="submit" name="add_job" style="margin-top:5px;" class="btn btn-success" value="Add Job" /></a>
      </center>
      <br /><br />
<?php
  ...
  while ($retrive = mysqli_fetch_array($result)) 
  {
    ...
    echo "<th><a href='update_job.php?upd=$id'<button class='btn btn-success'>Update Job Details</button></th>";
    echo "<th><a href='delete_job.php?del=$id'<button class='btn btn-danger'>Delete Job</button></th>";
