...
if(isset($_POST['submit'])){
   ...
   if($_POST["newPassword"] !== $_POST["confirmPassword"]){
      echo" <script>alert('New password and confirmed password must be same!')
          ...
          //fetch pass
         $result = mysqli_query($connection,"SELECT * FROM staff WHERE dept_name ='" . $dept_name . "'") or die(mysqli_error($connection));
         $row = mysqli_fetch_array($result);

            if($_POST["currentPassword"] == $row["password"]){
              //update password
              $result = mysqli_query($connection,"UPDATE staff SET password = '" . $_POST["newPassword"] . "' WHERE dept_name ='" . $dept_name . "'");
...
<div class="megacontainer" style="padding-top: 40px">
  ...
  <div class="container">
    ...
    <input type="Password" name="confirmPassword" placeholder=" Re-enter Password" required="">
      ...
      <center><h2><b><a href="staff_dashboard.php">Back</a></b></h2></center>
